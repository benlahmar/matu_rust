...
use crate::web::handlers::user_handler::{create_user, get_user_by_id, get_user_by_email, update_user, delete_user};
           ...
           // .app_data(user_service.clone()) // Clone for each worker thread
            ...
            .service(
                aw_web::scope("/users") // Base path for user-related routes
                    ...
                    .route("", aw_web::get().to(get_user_by_email)) // GET /users?email=...
